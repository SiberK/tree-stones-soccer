...
export function checkCleanPass() {
    ...
    if (!GameState.lastStruckStone || GameState.hasPassedThrough)
        return;
...
export function checkGoal() {
    ...
    if (!GameState.lastStruckStone || GameState.isGoalScored || !GameState.hasPassedThrough)
        return;
    const striker = GameState.lastStruckStone;
    const bStart = { x: striker.startX, y: striker.startY };
    const bEnd = { x: striker.x, y: striker.y };
